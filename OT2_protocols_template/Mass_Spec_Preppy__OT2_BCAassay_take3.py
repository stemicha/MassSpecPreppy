...
def run(protocol: protocol_api.ProtocolContext):
  ...
  tiprack20_4 = protocol.load_labware("opentrons_96_tiprack_20ul", "6",label = "opentrons_96_tiprack_20ul_4")
  ...
  prep_plate = protocol.load_labware("nest_96_wellplate_100ul_pcr_full_skirt", "2", label = "preparation_plate")
  BCA_plate = protocol.load_labware("nest_96_wellplate_100ul_pcr_full_skirt", "1", label  = "BCA_plate__half_area")
  #samples
  ...
  m20 = protocol.load_instrument("p20_multi_gen2", mount = "right", tip_racks=[tiprack20_4])
