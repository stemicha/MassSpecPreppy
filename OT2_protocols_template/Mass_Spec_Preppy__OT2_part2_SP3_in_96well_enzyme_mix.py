...
#specify meta data
metadata = {
     "protocolName": "Mass Spec Preppy: step 2 > SP3 preparation with enzyme mix digest",
     "apiLevel": "2.12",
...
def run(protocol: protocol_api.ProtocolContext):
  ...
  volume_LysC_Trypsin_Mix = (sample_amount*1000/LysC_Trypsin_Mix_ratio)/LysC_Trypsin_Mix_stock_concentration
  digest_buffer_volume = 22-volume_LysC_Trypsin_Mix # 22 µl final volume of digest
...
f{INCUBATION_TIME} minutes.')
  ...
  #transfer Trypsin_LysC_Mix stock to solution
  for i in range(0, math.ceil(sample_number/8)):
    m20.transfer(volume_LysC_Trypsin_Mix, 
  ...
  #comment step
  protocol.comment("take preparation plate out, seal it > place plate in MixMate and shake for at least 5 minutes at 3000rpm > short centrifugation with table plate centrifuge > incubate it at 37°C with MixMate at 1500rpm for 15-16hours.")
