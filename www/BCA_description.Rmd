...
The usage of the app is fairly simple.
Just download the excel template for your sample description (sample name, dilution factor, replicate). The edited excel table can then be uploaded together with the excel file output from the Gen5 software (Synergy H1 plate reader).

<span style="color:red; font-size: 28px">DO NOT USE “STD” or “BLK” in sample naming !!!</span>.
