...
#liquid heights
min_height = 2  # depth at which the pipette tip will stop descending into the tube
...
def vol_height_1_5_ml(initial_volume, aspirate_volume, height_below_mm):
  ...
  if height_out < min_height:  height_out = min_height-1.5
  #return height
  return height_out
...
def run(protocol: protocol_api.ProtocolContext):
  ...
  #column 3 = 40µl 12.5mM DTT in each well
  #column 4 = 50µl IAA (iodoacetamide) (50mM) in each well
  #column 5 = 100µl SP3 in each well
  ...
  #endconcentration of DTT = 2.5 mM and 10mM of IAA
  
  #transfer DTT to sample
  ...
  for i in range(0, math.ceil(sample_number/8)):
    m20.transfer(5, 
                 reagents.wells_by_name()["A5"].bottom(3), # 3mm from bottom
